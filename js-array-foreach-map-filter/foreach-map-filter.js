...
console.log(doubledValues([1,2,3]));
console.log(doubledValues([5,1,2,3,10]));
/*
...
function addKeyAndValue(arr, key, value) {
  ...
  // Output: The 'people' array is now modified with the new key-value pair for each object
  console.log(people);
  /*
...
function extractFullName(arr) {
    const fullNameArray = arr.map(function(obj) {
...
function removeVowels(str) {
    ...
    const filteredArray = lowerStr.split('').filter(function(char) {
...
function doubleOddNumbers(arr) {
    ...
    const doubledOddNumbers = oddNumbers.map(function(oddNumber) {
      return oddNumber * 2;
    });
